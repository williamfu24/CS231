...
alias com {
  ...
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/altera_merlin_traffic_limiter.sv"                                   -work nios2_processor_data_master_limiter       
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/altera_merlin_reorder_memory.sv"                                    -work nios2_processor_data_master_limiter       
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/altera_avalon_sc_fifo.v"                                            -work nios2_processor_data_master_limiter       
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/altera_avalon_st_pipeline_base.v"                                   -work nios2_processor_data_master_limiter       
  ...
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/altera_merlin_master_agent.sv"                                      -work nios2_processor_data_master_agent         
  ...
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/altera_merlin_master_translator.sv"                                 -work nios2_processor_data_master_translator    
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/nios_system_nios2_processor_cpu.vo"                                 -work cpu                                       
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/nios_system_nios2_processor_cpu_debug_slave_sysclk.v"               -work cpu                                       
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/nios_system_nios2_processor_cpu_debug_slave_tck.v"                  -work cpu                                       
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/nios_system_nios2_processor_cpu_debug_slave_wrapper.v"              -work cpu                                       
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/nios_system_nios2_processor_cpu_mult_cell.v"                        -work cpu                                       
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/nios_system_nios2_processor_cpu_test_bench.v"                       -work cpu                                       
  ...
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/nios_system_onchip_memory.v"                                        -work onchip_memory                             
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/nios_system_nios2_processor.v"                                      -work nios2_processor                           
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/nios_system_jtag_uart.v"                                            -work jtag_uart                                 
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/nios_system_HEXA.v"                                                 -work HEXA                                      
